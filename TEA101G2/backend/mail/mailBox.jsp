...
<%
	...
	List<FormListVO> list = formListSvc.selectAllMailByGet(loginEmpId);
...
<script>
  ...
  $(function(){
       $("button.btn btn-default trash").on("click", function(e){
    	   console.log("YOOOO")
            $("table.mailbox-name").fadeOut(1000, function(){
                $(this).remove();
            });
        });
  });
