...
//				FORM_STATUS----'R':已讀,'M':未讀
				String memberId = SpaceVO.getMemberId();
				...
				String memberName = msb.selectOneMember(memberId).getMemberName();
				String spaceType = SpaceVO.getSpaceType();
				
				if("T".equals(spaceStatus)) {
