		...
		<div class="box_general padding_bottom">
					...
					<div class="form-group">
						...
						<div class="styled2-select">
							<select name="spaceType">
							  ...
							  <option <%=(spaceVO.getSpaceType().contains("課程講座")? "selected":"")%>>課程講座</option>
							  <option <%=(spaceVO.getSpaceType().contains("親子活動")? "selected":"")%>>親子活動</option>
							  <option <%=(spaceVO.getSpaceType().contains("攝影棚")? "selected":"")%>>攝影棚</option>
							</select>
					  </div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						<label>場地上架日期</label>
						<input name="spaceOnsaleDate" id="f_date1" type="text" value="<%= (spaceVO == null)? "" : spaceVO.getSpaceOnsaleDate()%>"/>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label>場地下架日期</label>
						<input name="spaceOffsaleDate" id="f_date2" type="text" value="<%= (spaceVO == null)? "" : spaceVO.getSpaceOffsaleDate()%>"/>
					</div>
				</div>
			</div>
			<!-- /row-->
