...
<table>
			...
			<tr>
				<td>訂單創建日期:</td>
				<td><input name="orderCreateDate" id="orderCreateDate" type="text"></td>
			</tr>

		</table>

<br>
<input type="hidden" name="action" value="addOrderMaster">
<button name="add" value="新增" type="submit" class="add" onclick="javascript:return confirm('確認新增?');">送出新增</button>
<a href='<%=request.getContextPath()%>/frontend/orderMaster/orderMaster.jsp'><input type="button" value="取消新增"></a>
...
<% java.sql.Date orderCreateDate = new java.sql.Date(System.currentTimeMillis()); %>
...
<script>
        ...
        $('#orderCreateDate').datetimepicker({
	       theme: '',              //theme: 'dark',
