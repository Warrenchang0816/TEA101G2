...
<table>
			...
			<tr>
				...
				<td><input type="TEXT" name="orderAmount" size="45"
					...
					<span style="color:red"><%= (errorMsgs == null)? "" : (!orderMasterVO.getOrderAmount().equals(""))? "" : "  " + errorMsgs.poll()%></span></td>
			</tr>
...
<script>
        ...
        $('#orderCreateDate').datetimepicker({
		   ...
		   value: '<%=orderMasterVO.getOrderCreateDate()%>', // value:   new Date(),
           //disabledDates:        ['2017/06/08','2017/06/09','2017/06/10'], // 去除特定不含
           startDate:	            '<%=orderMasterVO.getOrderCreateDate()%>',  // 起始日
