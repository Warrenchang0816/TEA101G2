...
<body>
	...
	<header class="header menu_fixed">
		...
		<div id="logo">
			<a href="index.html">
				<img src="<%=request.getContextPath()%>/frontend/img/logo.svg" width="150" height="36" alt="" class="logo_normal">
				<img src="<%=request.getContextPath()%>/frontend/img/logo_sticky.svg" width="150" height="36" alt="" class="logo_sticky">
			</a>
		</div>
		<ul id="top_menu">
	...
	<main>
		...
		<section class="hero_in general">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>滿滿的大平台</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<a class="box_feat" href="#0">
						...
						<p>根據我的說法，哪怕是最令人欽佩的馬西姆也不例外。 我聽說您沒有其他選擇來解釋這些攻擊，因為這很奇怪。</p>
					</a>
				</div>
				<div class="col-lg-4 col-md-6">
					<a class="box_feat" href="#0">
				...
				<div class="row justify-content-between">
					<div class="col-lg-6 wow" data-wow-offset="150">
						<figure class="block-reveal">
							...
							<img src="img/BlobTest1.jpg" class="img-fluid" alt="">
						</figure>
					</div>
					<div class="col-lg-5">
