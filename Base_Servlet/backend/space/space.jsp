		...
		<ul>
			...
			<li>
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/SpaceServlet">
					...
					</select> <input type="hidden" name="action" value="backend_SelectOneSpace">
					<input type="submit" value="查詢">
				</FORM>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/backend/space/addSpace.jsp'><input type="button" value="新增"></a>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/backend/space/selectAllSapce.jsp'><input type="button" value="列表"></a>
			</li>
		</ul>
	</table>

	<a href='<%=request.getContextPath()%>/backend/spaceComm/spaceComm.jsp'><input type="button" value="場地評價"></a>
	<a href='<%=request.getContextPath()%>/backend/spaceDetail/spaceDetail.jsp'><input type="button" value="場地明細"></a>
	<a href='<%=request.getContextPath()%>/backend/spacePhoto/spacePhoto.jsp'><input type="button" value="場地圖片"></a>
