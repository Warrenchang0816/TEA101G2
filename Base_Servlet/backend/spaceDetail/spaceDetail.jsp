		...
		<ul>
			<li>
				<form method="post" action="<%=request.getContextPath()%>/SpaceDetailServlet">
					...
					<input type="hidden" name="action" value="backend_SelectOneSpaceDetail">
			...
			<li>
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/SpaceDetailServlet">
					...
					</select> <input type="hidden" name="action" value="backend_SelectOneSpaceDetail">
					<input type="submit" value="查詢">
				</FORM>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/backend/spaceDetail/addSpaceDetail.jsp'><input type="button" value="新增"></a>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/backend/spaceDetail/selectAllSpaceDetail.jsp'><input type="button" value="列表"></a>
			</li>
		</ul>
	</table>
