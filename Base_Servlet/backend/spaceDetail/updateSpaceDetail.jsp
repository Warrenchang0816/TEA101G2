...
<br>
<input type="hidden" name="action" value="backend_UpdateSpaceDetail">
...
<a href='<%=request.getContextPath()%>/backend/spaceDetail/spaceDetail.jsp'><input type="button" value="取消修改"></a>
