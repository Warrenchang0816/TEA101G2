...
<a href='<%=request.getContextPath()%>/backend/member/member.jsp'><input type="button" value="回會員頁面"></a>
<a href='<%=request.getContextPath()%>/backend/member/addMember.jsp'><input type="button" value="新增會員"></a>
<style>
    img {
      width: 200px;
    }
