		...
		<ul>
			<li>
				<form method="post" action="<%=request.getContextPath()%>/MemberCommServlet">
					...
					<input type="hidden" name="action" value="selectOneMemberComm">
			...
			<li>
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/MemberCommServlet">
					...
					</select> <input type="hidden" name="action" value="selectOneMemberComm">
					<input type="submit" value="查詢">
				</FORM>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/spaceComm/addSpaceComm.jsp'><input type="button" value="新增"></a>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/spaceComm/selectAllSpaceComm.jsp'><input type="button" value="列表"></a>
			</li>
		</ul>
	</table>
