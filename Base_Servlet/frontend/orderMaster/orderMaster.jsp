		...
		<ul>
			...
			<li>
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/OrderMasterServlet">
					...
					</select> <input type="hidden" name="action" value="selectOneOrderMaster">
					<input type="submit" value="查詢">
				</FORM>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/orderMaster/addOrderMaster.jsp'><input type="button" value="新增"></a>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/orderMaster/selectAllOrderMaster.jsp'><input type="button" value="列表"></a>
			</li>
		</ul>
	</table>
	
<a href='<%=request.getContextPath()%>/frontend/orderDetail/orderDetail.jsp'><input type="button" value="訂單明細"></a>
