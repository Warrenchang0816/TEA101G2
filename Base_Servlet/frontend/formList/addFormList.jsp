...
<table>
			...
			<tr>
				...
				<td><input type="TEXT" name="membrId" size="45"
					...
					<span style="color:red"><%= (errorMsgs == null)? "" : (!formListVO.getMembrId().equals(""))? "" : "  " + errorMsgs.poll()%></span></td>
			</tr>
			<tr>
				<td>員工編號:</td>
...
<a href='<%=request.getContextPath()%>/frontend/formList/formList.jsp'><input type="button" value="取消新增"></a>
