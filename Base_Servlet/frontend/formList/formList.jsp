...
<body>
<a href='<%=request.getContextPath()%>/frontend/BigSpace.jsp'><input type="button" value="回場地頁面"></a>
	<table>
		<ul>
			<li>
				<form method="post" action="<%=request.getContextPath()%>/FormListServlet">
					<input type="text" name="formListId" placeholder="請輸入客服表單編號">
					<input type="hidden" name="action" value="selectOneFormList">
			...
			<li>
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/FormListServlet">
					...
					</select> <input type="hidden" name="action" value="selectOneFormList">
					<input type="submit" value="查詢">
				</FORM>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/formList/addFormList.jsp'><input type="button" value="新增"></a>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/formList/selectAllFormList.jsp'><input type="button" value="列表"></a>
			</li>
		</ul>
	</table>
