...
INSERT INTO FORM_LIST(FORM_LIST_ID, MEMBER_ID, EMP_ID, FORM_CREATEDATE, FORM_LIST_TYPE, FORM_TITLE, FORM_CONTENT, FORM_STATUS) VALUES ( 'FORMS' || lpad(FORM_LIST_ID_SEQ.NEXTVAL, 7, '0'), 'MEM00001', 'EMP00002', '2020-09-17','客服', '網站錯誤回報', '剛剛的網頁存取行為發生了問題', 'done');
INSERT INTO FORM_LIST(FORM_LIST_ID, MEMBER_ID, EMP_ID, FORM_CREATEDATE, FORM_LIST_TYPE, FORM_TITLE, FORM_CONTENT, FORM_STATUS) VALUES ( 'FORMS' || lpad(FORM_LIST_ID_SEQ.NEXTVAL, 7, '0'), 'MEM00003',  'EMP00001','2020-09-19', '檢舉', '投訴', '場地髒亂，場主不處理', 'done');
---------------------------------------------------------------------------------------------------------
