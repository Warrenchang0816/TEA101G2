...
<br>
<input type="hidden" name="action" value="backend_UpdateMemberComm">
...
<a href='<%=request.getContextPath()%>/backend/memberComm/memberComm.jsp'><input type="button" value="取消修改"></a>
