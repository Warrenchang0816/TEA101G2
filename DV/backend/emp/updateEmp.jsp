  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="<%=request.getContextPath()%>/backend/emp/selectEmpAuth.jsp">更改員工權限</a>
        </li>
...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/EmpServlet" style="margin-bottom: 0px;">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select  size="1" name="empAuth">
									<option value = "1" ${(empVO == null)? "selected" : (empVO.empAuth == 1)? "selected" : ""}>一般員工</option>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select  size="1" name="empStatus">
									<option value = "O" ${empVO == null ? "selected" : empVO.empStatus.equals("O") ? "selected" : ""}>在職</option>
									<option value = "P" ${empVO == null ? "" : empVO.empStatus.equals("P") ? "selected" : ""}>停職</option>
									<option value = "L" ${empVO == null ? "" : empVO.empStatus.equals("L") ? "selected" : ""}>離職</option>
								</select>
								</div>
							</div>
						</div>
		...
		<div class="row">
			<div class="col-md-3">
			    ...
			    <input type="hidden" name="action"	value="backend_UpdateEmp">
			    <button name="update" type="submit" class="btn_1 medium" onclick="javascript:return confirm('確認更改?');">確定更改</button>
			</div>
			<div class="col-md-3">
