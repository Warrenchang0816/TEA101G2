...
<table>
			...
			<tr>
				<td>評價日期:</td>
				<td><input name="commDate" id="commDate" type="text" value="<%=spaceCommVO.getCommDate()%>"/></td>
			</tr>
		
		</table>

<br>
<input type="hidden" name="action" value="backend_UpdateSpaceComm">
...
<a href='<%=request.getContextPath()%>/backend/spaceComm/spaceComm.jsp'><input type="button" value="取消修改"></a>
