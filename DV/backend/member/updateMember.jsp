				...
				<div class="col-md-8 add_top_30">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>會員密碼</label>
								<input type="text" class="form-control" name="memberPassword" readonly
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>會員姓名</label>
								<input type="text" class="form-control" name="memberName" readonly
									value="<%= (memberVO == null)? "" : memberName%>"/>
							</div>
						</div>
						--%>
						<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<span style="color:red"><%= (errorMsgs == null)? "" : (!memberVO.getMemberStatus().equals("O") && memberVO.getMemberStatusComm().equals(""))? errorMsgs.poll() : "" %></span>
						</div>
					</div>
				</div>
				</div>
