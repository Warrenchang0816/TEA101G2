...
//					errorMsgs.add("員工圖片: 請勿空白");
				...
				if (!errorMsgs.isEmpty()) {
					...
					RequestDispatcher failureView = req.getRequestDispatcher("/backend/empProfile.jsp");
...
//				if (part == null) {
				...
				if (!errorMsgs.isEmpty()) {
					...
					RequestDispatcher failureView = req.getRequestDispatcher("/backend/emp/updateEmpBasic.jsp");
					failureView.forward(req, res);
					return;
				}
...
//				if (part == null) {
				...
				String url = "/backend/empProfile.jsp";
				RequestDispatcher sucessVeiw = req.getRequestDispatcher(url);
				sucessVeiw.forward(req, res);
