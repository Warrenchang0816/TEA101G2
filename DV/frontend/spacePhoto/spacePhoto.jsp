		...
		<ul>
			<li>
				<form method="post" action="<%=request.getContextPath()%>/SpacePhotoServlet">
					...
					<input type="hidden" name="action" value="selectOneSpacePhoto">
			...
			<li>
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/SpacePhotoServlet">
					...
					</select> <input type="hidden" name="action" value="selectOneSpacePhoto">
					<input type="submit" value="查詢">
				</FORM>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/spacePhoto/addSpacePhoto.jsp'><input type="button" value="新增"></a>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/spacePhoto/selectAllSpacePhoto.jsp'><input type="button" value="列表"></a>
			</li>
		</ul>
	</table>
