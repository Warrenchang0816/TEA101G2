		...
		<ul>
			...
			<li>
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/MemberServlet">
					...
					</select> <input type="hidden" name="action" value="selectOneMember">
					<input type="submit" value="查詢">
				</FORM>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/member/addMember.jsp'><input type="button" value="新增"></a>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/member/selectAllMember.jsp'><input type="button" value="列表"></a>
			</li>
		</ul>
	</table>
	
	<a href='<%=request.getContextPath()%>/frontend/memberComm/memberComm.jsp'><input type="button" value="會員評價"></a>
	<a href='<%=request.getContextPath()%>/frontend/memberFavorite/memberFavorite.jsp'><input type="button" value="會員最愛"></a>


<script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/js/all.min.js"></script>
<script src="<%=request.getContextPath()%>/frontend/jquery.js"></script>
<script src="<%=request.getContextPath()%>/frontend/member/member.js"></script>
