...
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009190001', 'SD00003', '2020-09-19 16:30', '2020-09-20 18:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009190002', 'SD00003', '2020-09-11 11:00', '2020-09-12 17:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009190003', 'SD00003', '2020-09-17 12:30', '2020-09-18 15:30' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009190001', 'SD00001', '2020-09-12 05:30', '2020-09-13 18:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009190002', 'SD00002', '2020-09-01 00:00', '2020-09-01 17:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009190003', 'SD00002', '2020-09-14 01:30', '2020-09-15 15:30' );
----------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------
INSERT INTO FORM_LIST(FORM_LIST_ID, MEMBER_ID, EMP_ID, FORM_CREATEDATE, FORM_LIST_TYPE, FORM_TITLE, FORM_CONTENT, FORM_STATUS) VALUES ( 'FORMS' || lpad(FORM_LIST_ID_SEQ.NEXTVAL, 7, '0'), 'MEM00003', 'EMP00002', '2020-01-27', '投訴', '租借問題相關', '請問你們的預約會保留多久呢', 'undo');
INSERT INTO FORM_LIST(FORM_LIST_ID, MEMBER_ID, EMP_ID, FORM_CREATEDATE, FORM_LIST_TYPE, FORM_TITLE, FORM_CONTENT, FORM_STATUS) VALUES ( 'FORMS' || lpad(FORM_LIST_ID_SEQ.NEXTVAL, 7, '0'), 'MEM00001', 'EMP00002', '2020-09-17','客服', '網站錯誤回報', '剛剛的網頁存取行為發生了問題', 'undo');
INSERT INTO FORM_LIST(FORM_LIST_ID, MEMBER_ID, EMP_ID, FORM_CREATEDATE, FORM_LIST_TYPE, FORM_TITLE, FORM_CONTENT, FORM_STATUS) VALUES ( 'FORMS' || lpad(FORM_LIST_ID_SEQ.NEXTVAL, 7, '0'), 'MEM00003',  'EMP00001','2020-09-19', '檢舉', '投訴', '場地髒亂，場主不處理', 'undo');
---------------------------------------------------------------------------------------------------------
