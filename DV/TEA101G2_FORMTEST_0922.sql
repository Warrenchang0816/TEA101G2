...
--------------------------------------------------------------------
INSERT INTO MEMBER ( MEMBER_ID, MEMBER_ACCOUNT, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_PHONE, MEMBER_ADDRESS, MEMBER_BIRTH, MEMBER_SEX, MEMBER_COUNTRY, MEMBER_SIGNUP_DATE, MEMBER_AUTH, MEMBER_STATUS ) VALUES ( 'MEM' || lpad(MEMBER_ID_SEQ.NEXTVAL, 5, '0' ), 'am6319146', 'ZHcoPk', '馬全德', '馬哥', 'gbauer9@tibame.edu.com', '0911-332233', '新北市中和區','1990-05-04', 'M', '美國','2015-08-12', 1, 'O' );
INSERT INTO MEMBER ( MEMBER_ID, MEMBER_ACCOUNT, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_PHONE, MEMBER_ADDRESS, MEMBER_BIRTH, MEMBER_SEX, MEMBER_COUNTRY, MEMBER_SIGNUP_DATE, MEMBER_AUTH, MEMBER_STATUS ) VALUES ( 'MEM' || lpad(MEMBER_ID_SEQ.NEXTVAL, 5, '0' ), 'bk53292916a', 'IML0bFfYUTo', '張互賓', '互賓', 'svolkes8@gmail.com', '0922-778877', '台北市中正區', '1969-03-25', 'M', '台灣','2016-04-27', 2, 'O' );
INSERT INTO MEMBER ( MEMBER_ID, MEMBER_ACCOUNT, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_PHONE, MEMBER_ADDRESS, MEMBER_BIRTH, MEMBER_SEX, MEMBER_COUNTRY, MEMBER_SIGNUP_DATE, MEMBER_AUTH, MEMBER_STATUS ) VALUES ( 'MEM' || lpad(MEMBER_ID_SEQ.NEXTVAL, 5, '0' ), 'tinsdgfl8421', '5354e1r48gd', '劉宜婷', '宜婷', 'yitibkjoldk511@tibame.edu.com', '0925-587786', '新北市中和區', '1981-05-03', 'F', '台灣','2019-05-05', 2, 'O' );
INSERT INTO MEMBER ( MEMBER_ID, MEMBER_ACCOUNT, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_PHONE, MEMBER_ADDRESS, MEMBER_BIRTH, MEMBER_SEX, MEMBER_COUNTRY, MEMBER_SIGNUP_DATE, MEMBER_AUTH, MEMBER_STATUS ) VALUES ( 'MEM' || lpad(MEMBER_ID_SEQ.NEXTVAL, 5, '0' ), 'lasjoir41', '56cvb41n89rt', '詹姆士', '喇叭詹', 'lejdflkgd1459we@gmail.com', '0915-547865', '新北市三重區', '1990-05-11', 'M', '台灣','2020-03-23', 2, 'O' );
...
NOCACHE;
----------------------------------------------------------------------
INSERT INTO EMP ( EMP_ID, EMP_ACCOUNT, EMP_PASSWORD, EMP_NAME, EMP_NICKNAME, EMP_EMAIL, EMP_PHONE, EMP_ADDRESS, EMP_BIRTH, EMP_SEX, EMP_COUNTRY, EMP_HIRE_DATE, EMP_JOB, EMP_AUTH, EMP_STATUS) values ('EMP' || lpad(EMP_ID_SEQ.NEXTVAL, 5, '0' ), 'sdw541dse', 'id7478dsaf', '何弋柏', '弋柏', 'mcomport0@gmail.com', '0912-345678', '台北市士林區', '1992/11/17', 'M', '澳洲', '2011/02/21', '後端工程師', 1, 'O');
...
INSERT INTO EMP ( EMP_ID, EMP_ACCOUNT, EMP_PASSWORD, EMP_NAME, EMP_NICKNAME, EMP_EMAIL, EMP_PHONE, EMP_ADDRESS, EMP_BIRTH, EMP_SEX, EMP_COUNTRY, EMP_HIRE_DATE, EMP_JOB, EMP_AUTH, EMP_STATUS) values ('EMP' || lpad(EMP_ID_SEQ.NEXTVAL, 5, '0' ), 'na1841es', 'vestibul78948', '吳冠宏', '小吳', 'etorbard2@tibame.edu.com', '0978-223355', '新北市汐止區', '1985/03/03', 'M', '台灣', '2015/09/18', '客服人員', 2, 'L');
INSERT INTO EMP ( EMP_ID, EMP_ACCOUNT, EMP_PASSWORD, EMP_NAME, EMP_NICKNAME, EMP_EMAIL, EMP_PHONE, EMP_ADDRESS, EMP_BIRTH, EMP_SEX, EMP_COUNTRY, EMP_HIRE_DATE, EMP_JOB, EMP_AUTH, EMP_STATUS) values ('EMP' || lpad(EMP_ID_SEQ.NEXTVAL, 5, '0' ), 'yang465wef', 'nmeikcgif41', '楊乃文', '小楊', '415sf18@tibame.edu.com', '0965-752752', '台北市南港區', '1996/03/03', 'F', '台灣', '2018/11/18', '客服人員', 1, 'O');
INSERT INTO EMP ( EMP_ID, EMP_ACCOUNT, EMP_PASSWORD, EMP_NAME, EMP_NICKNAME, EMP_EMAIL, EMP_PHONE, EMP_ADDRESS, EMP_BIRTH, EMP_SEX, EMP_COUNTRY, EMP_HIRE_DATE, EMP_JOB, EMP_AUTH, EMP_STATUS) values ('EMP' || lpad(EMP_ID_SEQ.NEXTVAL, 5, '0' ), 'sdw541dse', 'id7478dsaf', '何小明', '小明', 'Z748949615eqf@gmail.com', '0972-174555', '台北市萬華區', '1995/11/17', 'M', '台灣', '2019/05/11', '後端工程師', 1, 'O');
--------------------------------------------------------------------
...
INSERT INTO ORDER_MASTER(ORDER_MASTER_ID, MEMBER_ID, ORDER_CREATE_DATE, ORDER_AMOUNT, ORDER_STATUS) VALUES ( '20200920' || lpad(ORDER_MASTER_ID_SEQ.NEXTVAL, 4, '0'), 'MEM00002', '2020-09-18', 1750, 'P' );
INSERT INTO ORDER_MASTER(ORDER_MASTER_ID, MEMBER_ID, ORDER_CREATE_DATE, ORDER_AMOUNT, ORDER_STATUS) VALUES ( '20200921' || lpad(ORDER_MASTER_ID_SEQ.NEXTVAL, 4, '0'), 'MEM00003', '2020-09-18', 2100, 'R' );
INSERT INTO ORDER_MASTER(ORDER_MASTER_ID, MEMBER_ID, ORDER_CREATE_DATE, ORDER_AMOUNT, ORDER_STATUS) VALUES ( '20200922' || lpad(ORDER_MASTER_ID_SEQ.NEXTVAL, 4, '0'), 'MEM00003', '2020-09-18', 2100, 'C' );
INSERT INTO ORDER_MASTER(ORDER_MASTER_ID, MEMBER_ID, ORDER_CREATE_DATE, ORDER_AMOUNT, ORDER_STATUS) VALUES ( '20200923' || lpad(ORDER_MASTER_ID_SEQ.NEXTVAL, 4, '0'), 'MEM00002', '2020-09-18', 2100, 'F' );
------------------------------------------------------------------------------
...
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009200002', 'SD00002', '2020-09-18 10:00', '2020-09-18 17:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009210003', 'SD00003', '2020-09-18 11:30', '2020-09-18 15:30' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009220004', 'SD00003', '2020-09-19 16:30', '2020-09-20 18:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009230005', 'SD00003', '2020-09-11 11:00', '2020-09-12 17:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009190001', 'SD00003', '2020-09-17 12:30', '2020-09-18 15:30' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009200002', 'SD00001', '2020-09-12 05:30', '2020-09-13 18:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009210003', 'SD00002', '2020-09-01 00:00', '2020-09-01 17:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), '202009220004', 'SD00002', '2020-09-14 01:30', '2020-09-15 15:30' );
----------------------------------------------------------------------------------------
