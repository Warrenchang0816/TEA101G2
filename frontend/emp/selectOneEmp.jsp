...
<a href='<%=request.getContextPath()%>/frontend/emp/emp.jsp'><input type="button" value="回員工頁面"></a>
...
<table>
	...
	<tr>
		...
		<td><img src="<%=(empVO.getEmpPhoto() == null)? application.getRealPath("/frontend/img/BlobTest3.jpg") : "data:image/png;base64," + encode.encodeToString(empVO.getEmpPhoto())%>" class="perview"/></td>
		...
		<td>
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/EmpServlet" style="margin-bottom: 0px;">
			    ...
			    <input type="hidden" name="empId"  value="<%=empVO.getEmpId()%>">
			    <input type="hidden" name="action" value=deleteEmp></FORM>
		</td>
