...
<table>
			...
			<tr>
				<td>場地可出租日期:</td>
				<td><input type="TEXT" name="spaceDetailFreeDate" id="f_date1" /></td>
			</tr>
			<tr>
				<td>場地可出租的起始時段:</td>
...
<a href='<%=request.getContextPath()%>/frontend/spaceDetail/spaceDetail.jsp'><input type="button" value="取消新增"></a>
