...
<table>
			...
			<tr>
				<td>評價日期:</td>
				<td><input name="commDate" id="f_date1" type="text"></td>
			</tr>

		</table>

<br>
<input type="hidden" name="action" value="addSpaceComm">
<button name="addSpaceComm" value="新增" type="submit" class="addSpaceComm" onclick="javascript:return confirm('確認新增?');">送出新增</button>
<a href='<%=request.getContextPath()%>/frontend/spaceComm/spaceComm.jsp'><input type="button" value="取消新增"></a>
