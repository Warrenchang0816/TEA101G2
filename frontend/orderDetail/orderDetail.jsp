		...
		<ul>
			<li>
				<form method="post" action="<%=request.getContextPath()%>/OrderDetailServlet">
					...
					<input type="hidden" name="action" value="selectOneOrderDetail">
			...
			<li>
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/OrderDetailServlet">
					...
					</select> <input type="hidden" name="action" value="selectOneOrderDetail">
					<input type="submit" value="查詢">
				</FORM>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/orderDetail/addOrderDetail.jsp'><input type="button" value="新增"></a>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/frontend/orderDetail/selectAllOrderDetail.jsp'><input type="button" value="列表"></a>
			</li>
		</ul>
	</table>
