...
<br>
<input type="hidden" name="action" value="backend_AddSpace">
<button name="addSpace" value="新增" type="submit" class="addSpace" onclick="javascript:return confirm('確認新增?');">送出新增</button>
<a href='<%=request.getContextPath()%>/backend/space/space.jsp'><input type="button" value="取消新增"></a>
...
$('#spaceSignupDate').datetimepicker({
   ...
   value: '<%=spaceSignupDate%>', // value:   new Date(),
...
$('#spaceOnsaleDate').datetimepicker({
   ...
   step: 1,                //step: 60 (這是timepicker的預設間隔60分鐘)
   format:'Y-m-d',         //format:'Y-m-d H:i:s',
   value: '<%=spaceOnsaleDate%>', // value:   new Date(),
   //disabledDates:        ['2017/06/08','2017/06/09','2017/06/10'], // 去除特定不含
   //startDate:	            '2017/07/10',  // 起始日
   //minDate:               '-1970-01-01', // 去除今日(不含)之前
   //maxDate:               '+1970-01-01'  // 去除今日(不含)之後
...
$('#spaceOffsaleDate').datetimepicker({
   ...
   step: 1,                //step: 60 (這是timepicker的預設間隔60分鐘)
   format:'Y-m-d',         //format:'Y-m-d H:i:s',
   value: '<%=spaceOffsaleDate%>', // value:   new Date(),
   //disabledDates:        ['2017/06/08','2017/06/09','2017/06/10'], // 去除特定不含
   //startDate:	            '2017/07/10',  // 起始日
   //minDate:               '-1970-01-01', // 去除今日(不含)之前
   //maxDate:               '+1970-01-01'  // 去除今日(不含)之後
