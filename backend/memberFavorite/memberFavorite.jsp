		...
		<ul>
			<li>
				<form method="post" action="<%=request.getContextPath()%>/MemberFavoriteServlet">
					...
					<input type="hidden" name="action" value="backend_SelectOneMemberFavorite">
			...
			<li>
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/MemberFavoriteServlet">
					...
					</select> <input type="hidden" name="action" value="backend_SelectOneMemberFavorite">
					<input type="submit" value="查詢">
				</FORM>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/backend/memberFavorite/addMemberFavorite.jsp'><input type="button" value="新增"></a>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/backend/memberFavorite/selectAllMemberFavorite.jsp'><input type="button" value="列表"></a>
			</li>
		</ul>
	</table>
