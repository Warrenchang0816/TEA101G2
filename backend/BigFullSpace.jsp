    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href='<%=request.getContextPath()%>/frontend/emp/emp.jsp'>
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text">員工頁面</span>
          </a>
        </li>
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Messages">
          <a class="nav-link" href='<%=request.getContextPath()%>/frontend/emp/emp.jsp'>
            ...
            <span class="nav-link-text">會員頁面</span>
          </a>
        </li>
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="" data-original-title="Bookings">
          <a class="nav-link" href='<%=request.getContextPath()%>/frontend/emp/emp.jsp'>
            ...
            <span class="nav-link-text">場地頁面 <span class="badge badge-pill badge-primary">6 New</span></span>
          </a>
        </li>
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="My listings">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseMylistings" data-parent="#mylistings">
            ...
            <span class="nav-link-text">管理員工</span>
          </a>
