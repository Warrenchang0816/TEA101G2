...
<br>
<input type="hidden" name="action" value="backend_AddOrderMaster">
<button name="add" value="新增" type="submit" class="add" onclick="javascript:return confirm('確認新增?');">送出新增</button>
<a href='<%=request.getContextPath()%>/backend/orderMaster/orderMaster.jsp'><input type="button" value="取消新增"></a>
...
<script>
        ...
        $('#orderCreatDate').datetimepicker({
		   ...
		   value: '<%=orderCreatDate%>', // value:   new Date(),
