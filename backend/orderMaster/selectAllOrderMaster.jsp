...
<a href='<%=request.getContextPath()%>/backend/orderMaster/addOrderMaster.jsp'><input type="button" value="新增訂單"></a>
	...
	<tr>
		...
		<td>
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/OrderMasterServlet" style="margin-bottom: 0px;">
			    ...
			    <input type="hidden" name="orderMasterId"  value="${orderMasterVO.orderMasterId}">
			    <input type="hidden" name="action" value="backend_DeleteOrderMaster"></FORM>
		</td>
