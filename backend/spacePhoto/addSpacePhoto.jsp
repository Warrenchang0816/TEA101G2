...
<br>
<input type="hidden" name="action" value="backend_AddSpacePhoto">
<button name="addSpacePhoto" value="新增" type="submit" class="addSpacePhoto" onclick="javascript:return confirm('確認新增?');">送出新增</button>
<a href='<%=request.getContextPath()%>/backend/spacePhoto/spacePhoto.jsp'><input type="button" value="取消新增"></a>
