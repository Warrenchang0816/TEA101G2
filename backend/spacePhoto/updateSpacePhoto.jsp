...
<br>
<input type="hidden" name="action" value="backend_UpdateSpacePhoto">
...
<a href='<%=request.getContextPath()%>/backend/spacePhoto/spacePhoto.jsp'><input type="button" value="取消修改"></a>


</FORM>

<script src="<%=request.getContextPath()%>/backend/jquery.js"></script>
<script src="<%=request.getContextPath()%>/backend/spacePhoto/spacePhoto.js"></script>
