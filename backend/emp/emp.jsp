		...
		<ul>
			<li>
				<form method="post" action="<%=request.getContextPath()%>/EmpServlet">
					...
					<input type="hidden" name="action" value="backend_SelectOneEmp">
			...
			<li>
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/EmpServlet">
					...
					</select> <input type="hidden" name="action" value="backend_SelectOneEmp">
					<input type="submit" value="查詢">
				</FORM>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/backend/emp/addEmp.jsp'><input type="button" value="新增"></a>
			</li>

			<li>
				<a href='<%=request.getContextPath()%>/backend/emp/selectAllEmp.jsp'><input type="button" value="列表"></a>
			</li>
		</ul>
	</table>
...
<script src="<%=request.getContextPath()%>/backend/emp/emp.js"></script>
