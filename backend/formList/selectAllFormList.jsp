...
<a href='<%=request.getContextPath()%>/backend/formList/addFormList.jsp'><input type="button" value="新增客服表單"></a>
<style>
  table#table-1 {
	...
	<tr>
		...
		<td>
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/FormListServlet" style="margin-bottom: 0px;">
			    ...
			    <input type="hidden" name="formListId"  value="${formListVO.formListId}">
			    <input type="hidden" name="action" value="backend_DeleteFormList"></FORM>
		</td>
